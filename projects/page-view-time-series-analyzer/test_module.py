...
class LinePlotTestCase(unittest.TestCase):
    ...
    def test_line_plot_data_quantity(self):
        ...
        expected = 1238
        self.assertEqual(
            actual, expected, "Expected number of data points in line plot to be 1238."
        )
...
class BarPlotTestCase(unittest.TestCase):
    ...
    def test_bar_plot_labels(self):
        ...
        self.assertEqual(
            actual, expected, "Expected bar plot ylabel to be 'Average Page Views'"
        )
        actual = []
    ...
    def test_bar_plot_number_of_bars(self):
        ...
        expected = 49
        self.assertEqual(
            actual, expected, "Expected a different number of bars in bar chart."
        )
