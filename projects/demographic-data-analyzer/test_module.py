...
class DemographicAnalyzerTestCase(unittest.TestCase):
    ...
    def test_average_age_men(self):
        ...
        expected = 39.4
        self.assertAlmostEqual(
            actual, expected, msg="Expected different value for average age of men."
        )
    ...
    def test_min_work_hours(self):
        ...
        expected = 1
        self.assertAlmostEqual(
            actual, expected, msg="Expected different value for minimum work hours."
        )
    ...
    def test_highest_earning_country(self):
        ...
        expected = "Iran"
        self.assertEqual(
            actual, expected, "Expected different value for highest earning country."
        )
    ...
    def test_top_IN_occupation(self):
        ...
        self.assertEqual(
            actual, expected, "Expected different value for top occupations in India."
        )
